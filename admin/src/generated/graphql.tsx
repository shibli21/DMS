...
export type AddSemesterMutation = { __typename?: "Mutation" } & {
  addSemester: { __typename?: "SemesterResponse" } & {
    errors?: Maybe<
      Array<
...
export type AddSessionMutation = { __typename?: "Mutation" } & {
  addSession: { __typename?: "SessionResponse" } & {
    errors?: Maybe<
      Array<
        { __typename?: "FieldError" } & Pick<FieldError, "field" | "message">
      >
...
export type AdminLoginMutation = { __typename?: "Mutation" } & {
  adminLogin: { __typename?: "AdminResponse" } & {
    errors?: Maybe<
      Array<
        { __typename?: "FieldError" } & Pick<FieldError, "field" | "message">
      >
    >;
    admin?: Maybe<
      { __typename?: "Admin" } & Pick<Admin, "id" | "username" | "email">
    >;
  };
};
...
export type AdminRegisterMutation = { __typename?: "Mutation" } & {
  registerAdmin: { __typename?: "AdminResponse" } & {
    errors?: Maybe<
      Array<
        { __typename?: "FieldError" } & Pick<FieldError, "field" | "message">
      >
...
`;
export type AddSemesterMutationFn = Apollo.MutationFunction<
  AddSemesterMutation,
  AddSemesterMutationVariables
>;
 ...
 * });
 */
export function useAddSemesterMutation(
  baseOptions?: Apollo.MutationHookOptions<
    AddSemesterMutation,
    AddSemesterMutationVariables
  >
) {
  return Apollo.useMutation<AddSemesterMutation, AddSemesterMutationVariables>(
    AddSemesterDocument,
    baseOptions
  );
}
export type AddSemesterMutationHookResult = ReturnType<
  typeof useAddSemesterMutation
>;
export type AddSemesterMutationResult = Apollo.MutationResult<AddSemesterMutation>;
export type AddSemesterMutationOptions = Apollo.BaseMutationOptions<
  AddSemesterMutation,
  AddSemesterMutationVariables
>;
...
`;
export type AddSessionMutationFn = Apollo.MutationFunction<
  AddSessionMutation,
...
export function useAddSessionMutation(
  ...
  return Apollo.useMutation<AddSessionMutation, AddSessionMutationVariables>(
    AddSessionDocument,
    baseOptions
  );
}
export type AddSessionMutationHookResult = ReturnType<
  typeof useAddSessionMutation
>;
export type AddSessionMutationResult = Apollo.MutationResult<AddSessionMutation>;
export type AddSessionMutationOptions = Apollo.BaseMutationOptions<
  AddSessionMutation,
  AddSessionMutationVariables
>;
...
export function useAdminRegisterMutation(
  ...
  return Apollo.useMutation<
    AdminRegisterMutation,
    AdminRegisterMutationVariables
  >(AdminRegisterDocument, baseOptions);
}
